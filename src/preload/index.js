...
contextBridge.exposeInMainWorld('api', {
  ...
  confirmAssetMissing: (ids, note) => ipcRenderer.invoke('assets:confirmMissing', ids, note),
  revokeAssetMissing: (ids) => ipcRenderer.invoke('assets:revokeMissing', ids),
  assetsGetAuditLog: () => ipcRenderer.invoke('assets:getAuditLog'),
